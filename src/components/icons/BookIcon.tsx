...
export default function BookIcon({ className, size = 24 }: BookIconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M1000.2 341.9L548.5 614.2 70.4 502.8l478.1-259.9z" fill="#9ED5E4"></path>
      <path
        ...
        fill="#154B8B"
      ></path>
      <path d="M548.5 806L92.1 694.6c-43.4-5.4-71.7-71.2-69.5-120.7 1.3-29.8 17.8-71.2 69.5-71.2l456.3 111.4V806h0.1z" fill="#9ED5E4"></path>
      <path
        ...
        fill="#154B8B"
      ></path>
      <path d="M1000.2 533.7L548.5 806V614.2l451.7-272.3z" fill="#9ED5E4"></path>
      <path
        ...
        fill="#154B8B"
      ></path>
      <path d="M825.4 343.8L759.6 379l-243.7-49.8 70.7-35.3z" fill="#F7F8F9"></path>
      <path
