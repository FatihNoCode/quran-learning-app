...
// Audio helper for per-letter clips (used in Lesson 4)
...
// Custom Lesson 4 quizzes (replaces cloned defaults)
const lesson4Quizzes: Quiz[] = [
  // Bundle 1
  {
    ...
    question: { tr: 'Bu kelimenin harflerini seç.', nl: 'Kies de losse letters van dit woord.' },
    promptWord: 'كتب',
    options: [
  ...
  },
  {
    ...
    type: 'drag-drop',
    skill: 'letter-recognition-4',
    question: { tr: 'Harfleri sürükle ve kelimeyi oluştur.', nl: 'Sleep de letters en maak het woord.' },
    promptWord: 'فتح',
    items: [
      { id: 'word-فتح-1', content: { tr: 'ف', nl: 'ف' }, audioId: letterAudioMap['ف'] },
      { id: 'word-فتح-2', content: { tr: 'ت', nl: 'ت' }, audioId: letterAudioMap['ت'] },
      { id: 'word-فتح-3', content: { tr: 'ح', nl: 'ح' }, audioId: letterAudioMap['ح'] },
      { id: 'letter-slot-1', content: { tr: '[ _ ]', nl: '[ _ ]' } },
      { id: 'letter-slot-2', content: { tr: '[ _ ]', nl: '[ _ ]' } },
      { id: 'letter-slot-3', content: { tr: '[ _ ]', nl: '[ _ ]' } }
    ],
    correctPairs: [
      { sourceId: 'word-فتح-1', targetId: 'letter-slot-1' },
      { sourceId: 'word-فتح-2', targetId: 'letter-slot-2' },
      { sourceId: 'word-فتح-3', targetId: 'letter-slot-3' }
    ]
  },
  {
    id: 'lesson-4-b1-q3',
    ...
    type: 'multiple-choice',
    skill: 'letter-recognition-4',
    question: { tr: 'Bu harflerden hangi kelime oluşur?', nl: 'Welk woord maak je met deze letters?' },
  ...
  },
  {
    ...
    type: 'true-false',
    skill: 'letter-recognition-4',
    question: { tr: 'Kelime ve harfler eşleşiyor mu?', nl: 'Passen het woord en de letters bij elkaar?' },
    promptWord: 'عدل',
  ...
  },
  {
    ...
    type: 'drag-drop',
    skill: 'letter-recognition-4',
    question: { tr: 'Kelimeyi doğru harflere sürükle.', nl: 'Sleep het woord naar de juiste letters.' },
    items: [
  ...
  },
  {
    ...
    promptWord: 'وجد',
    items: [
      { id: 'word-وجد-1', content: { tr: 'و', nl: 'و' }, audioId: letterAudioMap['و'] },
      { id: 'word-وجد-2', content: { tr: 'ج', nl: 'ج' }, audioId: letterAudioMap['ج'] },
      { id: 'word-وجد-3', content: { tr: 'د', nl: 'د' }, audioId: letterAudioMap['د'] },
      { id: 'letter-slot-4', content: { tr: '[ _ ]', nl: '[ _ ]' } },
      { id: 'letter-slot-5', content: { tr: '[ _ ]', nl: '[ _ ]' } },
      { id: 'letter-slot-6', content: { tr: '[ _ ]', nl: '[ _ ]' } }
    ],
    correctPairs: [
      { sourceId: 'word-وجد-1', targetId: 'letter-slot-4' },
      { sourceId: 'word-وجد-2', targetId: 'letter-slot-5' },
      { sourceId: 'word-وجد-3', targetId: 'letter-slot-6' }
    ]
  },
  {
    id: 'lesson-4-b2-q3',
  ...
  },
  {
    ...
    promptWord: 'شكر',
    items: [
      { id: 'word-شكر-1', content: { tr: 'ش', nl: 'ش' }, audioId: letterAudioMap['ش'] },
      { id: 'word-شكر-2', content: { tr: 'ك', nl: 'ك' }, audioId: letterAudioMap['ك'] },
      { id: 'word-شكر-3', content: { tr: 'ر', nl: 'ر' }, audioId: letterAudioMap['ر'] },
      { id: 'letter-slot-7', content: { tr: '[ _ ]', nl: '[ _ ]' } },
      { id: 'letter-slot-8', content: { tr: '[ _ ]', nl: '[ _ ]' } },
      { id: 'letter-slot-9', content: { tr: '[ _ ]', nl: '[ _ ]' } }
    ],
    correctPairs: [
      { sourceId: 'word-شكر-1', targetId: 'letter-slot-7' },
      { sourceId: 'word-شكر-2', targetId: 'letter-slot-8' },
      { sourceId: 'word-شكر-3', targetId: 'letter-slot-9' }
    ]
  },
  {
    id: 'lesson-4-b3-q3',
  ...
  },
  {
    ...
    promptWord: 'اخذ',
    items: [
      { id: 'word-اخذ-1', content: { tr: 'ا', nl: 'ا' }, audioId: letterAudioMap['ا'] },
      { id: 'word-اخذ-2', content: { tr: 'خ', nl: 'خ' }, audioId: letterAudioMap['خ'] },
      { id: 'word-اخذ-3', content: { tr: 'ذ', nl: 'ذ' }, audioId: letterAudioMap['ذ'] },
      { id: 'letter-slot-10', content: { tr: '[ _ ]', nl: '[ _ ]' } },
      { id: 'letter-slot-11', content: { tr: '[ _ ]', nl: '[ _ ]' } },
      { id: 'letter-slot-12', content: { tr: '[ _ ]', nl: '[ _ ]' } }
    ],
    correctPairs: [
      { sourceId: 'word-اخذ-1', targetId: 'letter-slot-10' },
      { sourceId: 'word-اخذ-2', targetId: 'letter-slot-11' },
      { sourceId: 'word-اخذ-3', targetId: 'letter-slot-12' }
    ]
  },
  {
    id: 'lesson-4-b4-q3',
...
const lesson4: Lesson = {
  ...createLessonFromLesson1(4),
  quizzes: lesson4Quizzes,
  id: 'lesson-4',
  order: 4,
  level: 'Sayfa 4',
  content: {
    ...createLessonFromLesson1(4).content,
    title: 'Les 4: Combinaties van letters',
    titleTranslations: {
      tr: 'Ders 4: Harf birleşimleri',
      nl: 'Les 4: Combinaties van letters'
    }
  }
};
